...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference("Season.count") do
      post seasons_url, params: { season: { league_id: @season.league_id, name: @season.name } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { league_id: @season.league_id, name: @season.name } }
